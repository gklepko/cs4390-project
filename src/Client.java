...
public class Client extends JFrame {
    ...
    public Client() {
        ...
        //TODO Commented out because this doesn't properly disconnect the user once the window closes
        //frame.setDefaultCloseOperation(DO_NOTHING_ON_CLOSE);
        /*frame.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                int option = JOptionPane.showConfirmDialog(frame,"Do you wish to log out?",
                        "Exit",JOptionPane.YES_NO_OPTION);
                if (option == JOptionPane.YES_OPTION){
                    //TODO Handle disconnecting user here
    ...
    private void buildGUI() {
        ...
        //TODO commented out original scrollpane, but still accessable
